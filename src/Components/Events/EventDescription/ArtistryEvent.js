...
import ArtistryLogo from '../../../assets/EventLogo/artistry_logo.jpg';
         ...
         <Container component='div' maxWidth='lg' className='container'>
            <div className="event-title-box">
                ...
                <div className="event-logo">
                    <img src={ArtistryLogo} alt="Artistry logo"/>
                </div>
            </div>
            ...
            <div className="coordinators">
                ...
                <div className="member-1">
                    <Typography variant='h6' gutterBottom>
                        <PersonIcon/> 
                            <Tooltip title='19MX205' placement="top-end">                            
                                <span> Jaya Prakash S </span>
                            </Tooltip>
                    </Typography>
                    ...
                    <Typography variant='h6' gutterBottom>
                        ...
                        <span> 
                            <a className="member-contact" href="mailto:jayajp140@gmail.com">jayajp140@gmail.com</a> </span>
                    </Typography>
                    <Typography variant='h6'gutterBottom>
                        <PhoneIphoneIcon className='icon'/>  
                        <span>
                            <a className="member-contact" href="tel:9585951737">+91 9585951737 </a> 
                        </span>
                    </Typography>
                </div>                
            </div>
            ...
            <div className="bottom-nav">
                <center>
                    <div className="bottom-nev-box">
                        ...
                        <Typography variant='subtitle1' className="bottom-nav-txt">Artistry</Typography>
